    ...
    return (
        <Instagram>
            <div id="Ig-text">
                ...
                <p>
                    Empoderando a juventude LGBTQIA+ brasileira e lutando por um presente
                    mais inclusivo, visamos impactar o maior número de pessoas possíveis
                    disseminando conhecimento sobre a causa LGBTQIA+ para o público geral
                    e oferecendo capacitação social e acadêmica, além de auxílio psicológico
                    gratuito, para jovens LGBTQIA+.
                </p>
            </div>
            <div id="Ig-posts">
                <div>
                    {urls.map((url, index) => <Posts key={index} urlOne={url[0]} urlTwo={url[1]} index={index} />)}
                </div>
            </div>
            <div id="Divisor">
